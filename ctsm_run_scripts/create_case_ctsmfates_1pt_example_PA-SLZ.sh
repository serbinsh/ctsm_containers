...
export SITE_NAME=PA-SLZ							# which site?
...
export CLM_USRDAT_DOMAIN=domain_sherman_panama_v3_c180828.nc   		# Name of domain file in scripts/${SITE_DIR}/
export CLM_USRDAT_SURDAT=surfdata_sherman_panama_v3_c180828.nc 		# Name of surface file in scripts/${SITE_DIR}/
